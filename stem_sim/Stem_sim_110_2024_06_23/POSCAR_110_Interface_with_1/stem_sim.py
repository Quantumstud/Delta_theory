...
atoms = read('POSCAR_110_Interface_with_1',format='vasp')
...
probe = Probe(energy=300e3, semiangle_cutoff=28,device='cpu')
probe.grid.match(potential)

detector = FlexibleAnnularDetector()

gridscan = GridScan(start=[0.05*atoms_rotated.get_cell_lengths_and_angles()[0], 0.05*atoms_rotated.get_cell_lengths_and_angles()[1]], end=[0.95*atoms_rotated.get_cell_lengths_and_angles()[0], 0.95*atoms_rotated.get_cell_lengths_and_angles()[1]], sampling = 0.25)
