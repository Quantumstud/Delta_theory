...
for interface in Interfaces:
    ...
    s_base = s.copy()
    ## Just creates supercells of the given transformation vectors in the tranformation vector pickle file.
